...
public class RaportViewController {
	...
	{
		ResultSet rst=app.getAllRaportsData(Main.getCurrentRaportSearch().getIdRaport());
		String function=app.getFunctionUser(app.getCNPUser(Main.getUserName()));
	...
	private void intializeServiceTableView() throws SQLException {
		...
		ResultSet rst=app.getReportServices(Main.getCurrentRaportSearch().getIdRaport());
		while(rst.next())
		{
