...
public class SignUpController {
	...
	private void signUp() throws SQLException, IOException, InterruptedException {
		...
		if (txtCNP.getText().toString().length() == 0) {
		...
		} else if (app.getUserName(txtCNP.getText()).length() != 0) {
		...
		else if (txtUserName.getText().toString().length() != 0 && app.checUserName(txtUserName.getText().toString())) {
			...
			app.updateAfterSignUp(txtCNP.getText(), txtUserName.getText(), password1.getText());
