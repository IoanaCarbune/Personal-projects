...
public class MenuController {
	...
	private void initialize() throws SQLException {
		...
		if (!app.getFunctionUser(app.getCNPUser(userName)).equals("Medic")
				&& !app.getFunctionUser(app.getCNPUser(userName)).equals("Asistent medical")
				&& !app.getFunctionUser(app.getCNPUser(userName)).equals("Receptioner")
