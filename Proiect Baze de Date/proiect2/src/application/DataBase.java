...
public class DataBase {
	...
	private String url = "jdbc:mysql://localhost/lant_de_policlinici?useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
	private String uid = "ioana";
	private String pw = "ioana";
	...
	public static void main(String[] args) throws SQLException {
		...
		// app.checkAccount("dan", "dan");
		// specialties=app.getSpecialties();
		// System.out.println(specialties.get(0));
		// app.insertUser(null, null, null, null, null, null, null, null, null, null,
		// null, null, null, null, null);
		// System.out.println(app.checUserName("dan"));
	...
	public String decryptPassword(String userName) throws SQLException {
		String sql="select cast(aes_decrypt(password,'key1234') as char(100)) from utilizator where username='"+userName+"';";
		Statement stmt = con.createStatement();
		ResultSet rst = stmt.executeQuery(sql);
		System.out.println(sql);
